...
export const routes: Routes = [
  ...
  { path: "clients/:{id}", component: ListeClientComponent, canActivate: [(next: ActivatedRouteSnapshot, state: RouterStateSnapshot) => inject(AuthGuard).canActivate(next, state)]},
  { path: "clients", component: ListeClientComponent, canActivate: [AuthGuard]},
